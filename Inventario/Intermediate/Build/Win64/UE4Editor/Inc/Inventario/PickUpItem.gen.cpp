...
// End Cross Module References
	DEFINE_FUNCTION(IPickUpItem::execDrop)
	{
	...
	void UPickUpItem::StaticRegisterNativesUPickUpItem()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "Drop", &IPickUpItem::execDrop },
			{ "PickUp", &IPickUpItem::execPickUp },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UPickUpItem_Drop_Statics
	{
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_position = { "position", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PickUpItem_eventDrop_Parms, position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PickUpItem_eventDrop_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PickUpItem_eventDrop_Parms), &Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPickUpItem_Drop_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_position,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPickUpItem_Drop_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPickUpItem_Drop_Statics::Function_MetaDataParams[] = {
		{ "Category", "PickUpable" },
		{ "ModuleRelativePath", "Public/PickUpItem.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPickUpItem_Drop_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPickUpItem, nullptr, "Drop", nullptr, nullptr, sizeof(PickUpItem_eventDrop_Parms), Z_Construct_UFunction_UPickUpItem_Drop_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPickUpItem_Drop_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C820C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPickUpItem_Drop_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPickUpItem_Drop_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPickUpItem_Drop()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPickUpItem_Drop_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPickUpItem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPickUpItem_Drop, "Drop" }, // 2061171111
	...
	IMPLEMENT_CLASS(UPickUpItem, 1376620000);
	...
	static FName NAME_UPickUpItem_Drop = FName(TEXT("Drop"));
	bool IPickUpItem::Execute_Drop(UObject* O, FVector position)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPickUpItem::StaticClass()));
		PickUpItem_eventDrop_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UPickUpItem_Drop);
		if (Func)
		{
		...
		{
			Parms.ReturnValue = I->Drop_Implementation(position);
		}
		return Parms.ReturnValue;
	}
